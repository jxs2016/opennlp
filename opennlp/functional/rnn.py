...
class RNN(torch.nn.Module):
    ...
    def forward(self, inputs, seq_lengths=None, init_state=None,
        ...
        if seq_lengths is not None:
            ...
            packed_inputs = torch.nn.utils.rnn.pack_padded_sequence(sorted_inputs,
        ...
        pad_output, _ = torch.nn.utils.rnn.pad_packed_sequence(outputs, batch_first=self.batch_first)
        if self.batch_first:
